...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 16,
        "participants": ["ava@mergington.edu", "nate@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Drama Club": {
        "description": "Create and perform scenes, monologues, and plays",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["isabella@mergington.edu", "dylan@mergington.edu"]
    },
    "Science Club": {
